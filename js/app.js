(() => {
    ...
    function pageSlider() {
        if (document.querySelector(".screen__slider")) new swiper_core_Swiper(".screen__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    class DynamicAdapt {
        ...
        init() {
            ...
            this.nodes.forEach((node => {
                ...
                оbject.place = dataArray[2] ? dataArray[2].trim() : "first";
    ...
    window.onload = function() {
        const isGuideDismissed = localStorage.getItem("guideDismissed");
        if (isGuideDismissed === "true") {
            hideGuideSection();
